...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 16,
        "participants": ["isaac@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim practice, technique coaching, and local competitions",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore scientific challenges",
